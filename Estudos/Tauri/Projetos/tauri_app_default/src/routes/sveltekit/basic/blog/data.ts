export const posts = [
    ...
    },
    {
        slug: "safety",
        title: "Safety notice",
        content: "<p>While safety is one of many Enrichment Center Goals, the Aperture Science High Energy Pellet, seen to the left of the chamber, can and has permanent disabilities , such as vaporization. Please be careful.</p>",
    },
    {
        slug: "cake",
